...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        /// <summary>
        /// This method will create a Grade book based on the type inputted or return an invalid message.
        /// </summary>
        /// <param name="command">command to create gradebook.</param>
        public static void CreateCommand(string command)
        {
            ...
            {
                Console.WriteLine("No valid true/false option provided. please try again.");
                return;
            }
